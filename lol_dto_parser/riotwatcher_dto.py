...
from lol_dto_parser.match_to_game import match_to_game
from lol_dto_parser.match_timeline_to_game import match_timeline_to_game


class MatchApiDtoV4(MatchApiV4):
    """A simple wrapper for the MatchV4 endpoints that we can cast to a LoL DTO.

    More of a proof of concept class than anything, not meant to be used as-is.
    """

    def game_from_match(self, region: str, match_id: int) -> lol_dto.classes.game.LolGame:
    ...
    def game_from_timeline(self, region: str, match_id: int) -> lol_dto.classes.game.LolGame:
    ...
    def full_game(self, region: str, match_id: int) -> lol_dto.classes.game.LolGame:
